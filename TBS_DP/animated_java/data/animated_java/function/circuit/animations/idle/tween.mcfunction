...
tag @s add aj.circuit.animation.idle.playing
...
execute at @s run function animated_java:circuit/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:circuit/animations/idle/zzz/apply_frame {frame: $(to_frame)}
